...
- [x] **AI-suggested racing line**: Before the race starts, show a visualization of the optimal racing line (computed by the AI from its learned behavior). Player can try to follow it. Post-race, overlay the player's actual line vs the AI's suggested line for comparison.
...
- [x] **Wind/air rush noise at speed**: Add a white noise layer to `useEngineSound.ts`. Highpass filter at `1000 + speed * 5` Hz, volume `Math.min(0.15, (speed - 80) / 800)`. Start at 80 km/h. Creates the constant backdrop that makes high speed feel intense and silence feel peaceful.
...
**1. Haptic Steering Wheel via Phone Gyroscope** [DONE]
...
**2. Eye-Tracking Steering via Webcam** [DONE]
...
**4. Head-Tracking Camera Control** [DONE]
...
**6. Browser Tab Rearview Mirror** [DONE]
...
**11. Twitch Plays Shadow Driver** [DONE]
...
**13. The Saddest Leaderboard** [DONE]
...
**16. The AI That Holds Grudges** [DONE]
...
**17. AI Nemesis System (Shadow of Mordor meets Racing)** [DONE]
...
**18. AI That Narrates Its Own Thoughts** [DONE]
...
**20. AI That Copies Your Mistakes** [DONE]
...
**21. AI Backseat Driver Mode** [DONE]
...
**24. Reverse Race -- Start at the Finish** [DONE]
...
**34. Synthwave Aesthetic Mode** [DONE]
...
**35. Heartbeat Audio Scaling** [DONE]
...
**38. Binaural 3D Audio Positioning** [DONE]
...
**40. The Game Knows Your Browser** [DONE]
...
**41. Time-Zone-Aware Racing** [DONE]
...
**44. Cursor Trail Racing Line** [DONE]
...
**46. Battery-Powered Difficulty** [DONE]
...
**50. The Race That Remembers Everyone** [DONE]
